                ...
                <div class="card-body">
                    ...
                    @if (count($counters) > 0)
                        ...
                        <table id="basic-datatable" class="table table-striped dt-responsive w-100">
                            ...
                            <tbody>
                            @php $desc = count($counters); $asc=0; @endphp
                    ...
                    @if (isset($counter_section))
                        @if ($demo_mode == "on")
                            <!-- Include Alert Blade -->
                                @include('admin.demo_mode.demo-mode')
                            @else
                                <form action="{{ route('counter-section.update', $counter_section->id) }}" method="POST">
                                    @method('PUT')
                                    @csrf
                                    @endif
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="title">{{ __('content.title') }} <span class="text-red">*</span></label>
                                        <input type="text" name="title" class="form-control" id="title" value="{{ $counter_section->title }}" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
